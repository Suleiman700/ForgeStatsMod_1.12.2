...
public class Chat {
    ...
    public static void ShowHelp() {
        ...
        player.sendMessage(new TextComponentString("#stats_jumps => Jump stats").setStyle(new Style().setColor(TextFormatting.RED).setClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "#stats_jumps"))));
